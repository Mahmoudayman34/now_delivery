...
/// Pickups screen displaying pickup requests grouped by zones
class PickupsScreen extends ConsumerWidget {
        ...
        data: (pickupsMap) {
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemCount: pickupsMap.length,
              itemBuilder: (context, index) {
                final zone = pickupsMap.keys.elementAt(index);
                final pickups = pickupsMap[zone]!;

                return _ZoneSection(
                  zone: zone,
                  itemCount: pickups.length,
                  itemLabel: pickups.length == 1 ? 'pickup' : 'pickups',
                  ...
                  children: pickups.map((pickup) => PickupCard(
                    ...
                    onTap: driverStatus.isOnline ? () async {
                      ...
                      // If result is true, refresh the pickups list
